      	...
      	<div class="row-fluid">
      		...
      		<div class="well">
		      	<?php if ($page != 'plot'): ?><div class="input-prepend input-append">
		      		<span class="add-on"><?php echo $name . "://" ?></span><input class="span10" type="text" placeholder="type path here" id="inputPath" value="<?php if(($page == "sub") || ($page == "proc")){ echo $page . "/"; } ?>"><button class="btn" type="button" onclick="footerResp('default')">Go!</button>
		      	</div>
		      	<?php endif; ?>
