...
public class SBSFileLoader {
    ...
    protected static SBSTablesLib tables = new SBSTablesLib();
        ...
        try {
            ...
            while(true){
                ...
                if(f==null){
                    ...
                    //get the username and id for this filepath
                    ArrayList<String> id_user = (ArrayList<String>)tables.getUsernameId(f.getPath());
                    if(id_user!=null && id_user.size()==2){
                        //create the metric if it doesn't exist
                        String metricStr = new StringBuffer().append("sbs.").append(id_user.get(0)/*id*/).append(id_user.get(1)/*user*/).toString();
                        if(!tables.containsMetric(metricStr))
                            tables.createMetric(metricStr);
                        ...
                        while(true){
                            ...
                            //handle gutp data
                                ...
                                label.replaceAll("\\s+","");
                                System.out.println("sbs.user.123 " + tokens.elementAt(0) + " "  + tokens.elementAt(1) + " label=" + label);
                            }
